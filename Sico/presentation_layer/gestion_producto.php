<?php	
	...
	echo "<section class='cols'>
		...
		<h4>Dar de Alta Producto</h4><a href='gestion_producto_dar_alta.php' class='button1'><img src='images/nuevo2.jpg' height='50' width='50'> </a></div>
		</section>"; 
	...
	{	
		...
		echo 	"<br><a href='gestion_producto_modificar.php?id=".$categoria[$i]->get_id_producto()."' class='button1'>Modificar</a></div>
				 <br><a href='gestion_producto_eliminar.php?id=".$categoria[$i]->get_id_producto()."' class='button1'>Dar de Baja</a></div></section>";	
	}	
	echo "</div>";
?>